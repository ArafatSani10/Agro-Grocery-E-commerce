...
function OrderSummary() {
  ...
  const { cartTotalAmount, discountAmount, couponCode, shippingCost } =
  ...
  const finalTotal = Math.max(
    0,
    cartTotalAmount + (shippingCost || 0) - discountAmount,
  );
      ...
      <div className="border p-5 lg:px-8 lg:py-8 rounded-lg bg-white order-1 sm:order-2">
        ...
        <div className="flex items-center mt-4 py-4 lg:py-4 text-sm w-full font-semibold text-heading last:border-b-0 last:text-base last:pb-0 ">
          <form onSubmit={handleApplyCoupon} className="w-full">
            <div className="flex flex-col sm:flex-row items-start justify-end">
              ...
              {couponCode ? (
                <button
                  ...
                  className="md:text-sm text-white bg-red-500 leading-4 inline-flex items-center cursor-pointer transition ease-in-out duration-300 font-semibold text-center justify-center border border-red-500 rounded-md px-5 md:px-6 lg:px-8 py-3 md:py-3.5 lg:py-3 mt-3 sm:mt-0 sm:ml-3 md:mt-0 md:ml-3 lg:mt-0 lg:ml-3 h-12 text-sm lg:text-base w-full sm:w-auto"
                >
                  Remove
                </button>
              ) : (
                <button
                  ...
                  className="md:text-sm text-black leading-4 inline-flex items-center cursor-pointer transition ease-in-out duration-300 font-semibold text-center justify-center border border-gray-200 rounded-md placeholder-white focus-visible:outline-none focus:outline-none px-5 md:px-6 lg:px-8 py-3 md:py-3.5 lg:py-3 mt-3 sm:mt-0 sm:ml-3 md:mt-0 md:ml-3 lg:mt-0 lg:ml-3 hover:text-white hover:bg-emerald-500 h-12 text-sm lg:text-base w-full sm:w-auto disabled:opacity-60"
                >
            ...
            {couponMessage && (
              <p
                className={`text-xs mt-2 ${couponCode ? "text-emerald-600" : "text-red-500"}`}
              >
                {couponMessage}
              </p>
            )}
